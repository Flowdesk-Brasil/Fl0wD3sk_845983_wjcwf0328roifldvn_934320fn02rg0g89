...
export function BotMissingModal({
  ...
  const contentShellClassName =
    scope === "workspace-main"
      ? "relative z-[10] min-h-full px-[20px] py-[32px] md:px-6 lg:px-8 xl:pl-[40px] xl:pr-[42px]"
      : scope === "parent"
        ? "relative z-[10] flex min-h-full items-center justify-center"
        : "relative z-[10] min-h-full px-[18px] py-[28px] md:px-6";
  const centerClassName =
    scope === "parent"
      ? ""
      : "mx-auto flex min-h-[calc(100vh-64px)] w-full max-w-[1220px] items-center justify-center";
  const portalTarget =
    scope === "parent" || typeof document === "undefined"
      ? null
      : document.body;
