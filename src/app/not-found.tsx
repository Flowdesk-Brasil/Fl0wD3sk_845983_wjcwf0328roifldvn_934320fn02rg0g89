  ...
  return (
    <main className="grid min-h-screen place-items-center bg-[#f7f9fc] p-5">
      <section className="card max-w-md p-8 text-center">
        ...
        <h1 className="mt-5 text-xl font-bold tracking-[-.03em]">PÃ¡gina nÃ£o encontrada</h1>
        <p className="mt-2 text-xs leading-5 text-[#657085]">O endereÃ§o informado nÃ£o existe ou foi removido.</p>
