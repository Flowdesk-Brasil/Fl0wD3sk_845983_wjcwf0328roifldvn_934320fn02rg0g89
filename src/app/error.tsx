  ...
  return (
    <main className="grid min-h-screen place-items-center bg-[#f7f9fc] p-5">
      <section className="card max-w-md p-8 text-center">
        ...
        <h1 className="mt-5 text-xl font-bold tracking-[-.03em]">Algo não saiu como esperado</h1>
        <p className="mt-2 text-xs leading-5 text-[#657085]">A operação foi interrompida para proteger seus dados. Tente novamente.</p>
