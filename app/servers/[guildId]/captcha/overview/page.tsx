...
type ServersCaptchaOverviewPageProps = {
  params: Promise<{
    guildId: string;
  }>;
};
...
export default async function ServersCaptchaOverviewPage({
  params,
}: ServersCaptchaOverviewPageProps) {
  ...
  return (
    <ServersWorkspace
      ...
      initialTab="settings"
      initialSettingsSection="captcha_overview"
    />
  );
}
