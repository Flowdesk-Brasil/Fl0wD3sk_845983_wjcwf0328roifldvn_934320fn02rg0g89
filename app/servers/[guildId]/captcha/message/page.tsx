...
type ServersCaptchaMessagePageProps = {
  params: Promise<{
    guildId: string;
  }>;
};
...
export default async function ServersCaptchaMessagePage({
  params,
}: ServersCaptchaMessagePageProps) {
  ...
  return (
    <ServersWorkspace
      ...
      initialTab="settings"
      initialSettingsSection="captcha_message"
    />
  );
}
