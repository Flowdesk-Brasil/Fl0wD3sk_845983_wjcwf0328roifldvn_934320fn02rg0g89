...
type ServersTimeclockRankingPageProps = {
  params: Promise<{
    guildId: string;
  }>;
};
...
export default async function ServersTimeclockRankingPage({
  params,
}: ServersTimeclockRankingPageProps) {
  ...
  return (
    <ServersWorkspace
      ...
      initialTab="settings"
      initialSettingsSection="timeclock_ranking"
    />
  );
}
