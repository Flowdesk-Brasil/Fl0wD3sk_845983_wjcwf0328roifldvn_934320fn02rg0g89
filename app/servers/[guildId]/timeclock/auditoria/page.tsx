...
type ServersTimeclockAuditPageProps = {
  params: Promise<{
    guildId: string;
  }>;
};
...
export default async function ServersTimeclockAuditPage({
  params,
}: ServersTimeclockAuditPageProps) {
  ...
  return (
    <ServersWorkspace
      ...
      initialTab="settings"
      initialSettingsSection="timeclock_audit"
    />
  );
}
