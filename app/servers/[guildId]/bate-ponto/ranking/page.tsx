...
type ServersBatePontoRankingPageProps = {
  params: Promise<{
    guildId: string;
  }>;
};
...
export default async function ServersBatePontoRankingPage({
  params,
}: ServersBatePontoRankingPageProps) {
  ...
  return (
    <ServersWorkspace
      ...
      initialTab="settings"
      initialSettingsSection="bate_ponto_ranking"
    />
  );
}
