...
type ServersBatePontoMessagePageProps = {
  params: Promise<{
    guildId: string;
  }>;
};
...
export default async function ServersBatePontoMessagePage({
  params,
}: ServersBatePontoMessagePageProps) {
  ...
  return (
    <ServersWorkspace
      ...
      initialTab="settings"
      initialSettingsSection="bate_ponto_message"
    />
  );
}
