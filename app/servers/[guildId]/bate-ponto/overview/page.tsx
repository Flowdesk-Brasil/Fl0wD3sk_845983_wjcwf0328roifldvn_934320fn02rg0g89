...
type ServersBatePontoOverviewPageProps = {
  params: Promise<{
    guildId: string;
  }>;
};
...
export default async function ServersBatePontoOverviewPage({
  params,
}: ServersBatePontoOverviewPageProps) {
  ...
  return (
    <ServersWorkspace
      ...
      initialTab="settings"
      initialSettingsSection="bate_ponto_overview"
    />
  );
}
