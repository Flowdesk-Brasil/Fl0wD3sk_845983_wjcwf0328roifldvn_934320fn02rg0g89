...
type ServersBatePontoHistoryPageProps = {
  params: Promise<{
    guildId: string;
  }>;
};
...
export default async function ServersBatePontoHistoryPage({
  params,
}: ServersBatePontoHistoryPageProps) {
  ...
  return (
    <ServersWorkspace
      ...
      initialTab="settings"
      initialSettingsSection="bate_ponto_history"
    />
  );
}
