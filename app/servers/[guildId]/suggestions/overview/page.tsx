...
type ServersSuggestionsOverviewPageProps = {
  params: Promise<{
    guildId: string;
  }>;
};
...
export default async function ServersSuggestionsOverviewPage({
  params,
}: ServersSuggestionsOverviewPageProps) {
  ...
  return (
    <ServersWorkspace
      ...
      initialTab="settings"
      initialSettingsSection="suggestions_overview"
    />
  );
}
