...
type ServersSuggestionsMessagePageProps = {
  params: Promise<{
    guildId: string;
  }>;
};
...
export default async function ServersSuggestionsMessagePage({
  params,
}: ServersSuggestionsMessagePageProps) {
  ...
  return (
    <ServersWorkspace
      ...
      initialTab="settings"
      initialSettingsSection="suggestions_message"
    />
  );
}
