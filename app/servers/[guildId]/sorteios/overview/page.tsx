...
type ServersSorteioOverviewPageProps = {
...
export default async function ServersSorteioOverviewPage({
  params,
}: ServersSorteioOverviewPageProps) {
  ...
  return (
    <ServersWorkspace
      ...
      initialTab="settings"
      initialSettingsSection="sorteio_overview"
    />
  );
}
