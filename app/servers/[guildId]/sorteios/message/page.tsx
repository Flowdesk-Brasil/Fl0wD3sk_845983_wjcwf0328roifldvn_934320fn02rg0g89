...
type ServersSorteioMessagePageProps = {
...
export default async function ServersSorteioMessagePage({
  params,
}: ServersSorteioMessagePageProps) {
  ...
  return (
    <ServersWorkspace
      ...
      initialTab="settings"
      initialSettingsSection="sorteio_message"
    />
  );
}
